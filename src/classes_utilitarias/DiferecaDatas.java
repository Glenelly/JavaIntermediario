...
public class DiferecaDatas {
    public static void main(String[] args) {

        try {
            diferecaDataAteJava7();
        ...
        diferecaDataJava8ComTempo();

        diferencaDataJava8ComChronoUnit();

    }

    public static void diferecaDataAteJava7() throws ParseException {
    ...
    public static void diferencaDataJava8(){
        ...
        LocalDate data1 = LocalDate.of(2019, 7, 6);
        LocalDate data2 = LocalDate.of(2020, 8, 10);
    ...
    public static void diferecaDataJava8ComTempo(){
    ...
    public static void diferencaDataJava8ComChronoUnit(){
        LocalDateTime data1 = LocalDateTime.of(2019, 1, 1,6,30);
        LocalDateTime data2 = LocalDateTime.of(2019, 1, 9,8,30);
